...
//   "Integration with external enterprise systems and APIs, including Telekom B2B interfaces and Microsoft Graph.",
//   "Implementation of long-running and stateful workflows using Temporal, including orchestration of asynchronous activities, retries, and failure handling.",
...
//   "Design of robust and performant data access layers using Entity Framework Core with PostgreSQL and MSSQL, ensuring tenant isolation and data consistency.",
